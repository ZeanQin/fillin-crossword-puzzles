...
% Student ID: 604030
% Date:       16th Oct 2016
% Purpose:    This file implements a fillin puzzle in prolog. A
%             description of the puzzle can be found here:
%             https://en.wikipedia.org/wiki/Fill-In_(puzzle).
%             
%             The program contains a main predicate which takes three
%             arguments: PuzzleFile, WordlistFile and SolutionFile.
%             The PuzzleFile contains the unsolved puzzle, the 
%             WordlistFile contains the list of words to be filled in
%             and the results will be written to the specificed 
%             SolutionFile. 
%
%             The hardest part is the solve_puzzle predicate. See the 
%             documentation for the method for how it works. 
%
%             The end of the file also contains some generic utility 
%             functions I have written which can be imported to other 
%             programs. 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
